...
public:
    ...
    {
        return CLOUD_FN(spark_variable(varKey, (const void*)userVar, T::TYPE_ID, NULL), false);
    }

    static inline bool _variable(const char *varKey, const int32_t* userVar, const CloudVariableTypeInt& userVarType)
    {
        return CLOUD_FN(spark_variable(varKey, (const void*)userVar, CloudVariableTypeInt::TYPE_ID, NULL), false);
    }
    ...
    static inline bool _variable(const T *varKey, const String *userVar, const CloudVariableTypeString& userVarType)
    {
        ...
        return CLOUD_FN(spark_variable(varKey, userVar, CloudVariableTypeString::TYPE_ID, &extra), false);
    }
